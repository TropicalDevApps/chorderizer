...
def _sanitize_path(path_input: str, default: str, base_dir: str) -> str:
    ...
    # Normalize the base directory path resolving symlinks
    base_dir = os.path.realpath(base_dir)

    # Join and resolve the path resolving symlinks
    full_path = os.path.realpath(os.path.join(base_dir, path_input))
